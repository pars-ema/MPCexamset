function [t, y_true, y_measured] = simulate_sde(t, x0, u, d, p, sigma_measurement, show_plot, outputFolder)
% SIMULATE_SDE
...
% ------------------------------------------------------------
    ...
    y_true(:,1) = FourTankSystemSensor(x(:,1), p);
    y_measured(:,1) = y_true(:,1) + randn(4,1) .* sigma_measurement;
